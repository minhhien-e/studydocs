...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleGeneral(Exception ex) {
        ...
        return ResponseEntity.internalServerError()
                .body(ApiResponse.error(500, -1)); // unknown error
    }
}
