...
public class NotificationRecipientOutboxRepository extends AbstractMongoNestedOutboxRepository {
    public NotificationRecipientOutboxRepository(MongoTemplate mongoTemplate, DomainEventSerializer domainEventSerializer) {
        super(mongoTemplate, domainEventSerializer);
    }
