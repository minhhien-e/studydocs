...
@Component
public class EditTemplateDescriptionHandler
    extends AbstractHandler<EditTemplateDescriptionCommand, Void> {
    
    protected EditTemplateDescriptionHandler(EditTemplateDescriptionUseCasePort useCase) {
